AFRAME.registerComponent("atoms", {
  ...
  createAtoms: async function (element) {
    ...
    for(var num = 1;num<=numOfElectron;num++){
      ...
      electronAngle += 65;
      electronGroup.setAttribute("animation",{property: "rotation",to: `0 0 0 -360`,loop: "true", dur: 3500, easing: "linear"});
      ...
      electron.setAttribute("material",{color: "#0D4781",opacity: 0.6});
